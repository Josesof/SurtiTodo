...
public interface OcrdRepository extends CrudRepository<OCRD, String> {
	...
	@Query(value = "INSERT INTO terceros (CardCode,CardName,GroupCode,LicTradNum,E_Mail,Phone1,AddID,SlpCode,U_HBT_RegTrib,U_HBT_TipDoc,U_HBT_MunMed,U_HBT_TipEnt\r\n"
			+ ",U_HBT_Nombres,U_HBT_Apellido1,U_HBT_Apellido2,U_HBT_Nacional,U_HBT_TipExt,U_HBT_ResFis,GroupNum,Listanum,Discount,\r\n"
			+ "CreditLine,DebtLine,U_GSP_GENDER,U_CatalogosActivos,U_CRMContrasena,Address,City,Country,U_HBT_DirMM) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)", nativeQuery = true)
	public void saveSocio(Long CardCode, String CardName, int GroupCode, String LicTradNum, String E_Mail,
			...
			String U_CRMContrasena, String Address, String City, String Country, String U_HBT_DirMM);
